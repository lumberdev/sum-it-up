    ...
    <>
      ...
      <Container className="mt-10 p-10 text-justify text-paragraph text-dark">
        <div className="mb-[4rem] text-[1.5rem]">
          <h1 className="mt-[3rem] text-center text-[3rem] font-bold leading-[4rem]">Terms and Conditions</h1>
          <p className="mt-2 text-center text-[1.4rem] italic">Last updated: February 28, 2023</p>
          <p className="mb-5 text-center text-[1.4rem] italic">
            Please read these terms and conditions carefully before using Our Service.
          </p>
          <h1 className="my-[3rem] text-center text-[3rem] font-bold leading-[4rem]">Interpretation and Definitions</h1>
          ...
          <p className="mb-5 text-[1.5rem]">For the purposes of these Terms and Conditions:</p>
          <ul>
            <li>
              <p className="mb-5 text-[1.5rem]">
            ...
            <li>
              <p className="mb-5 text-[1.5rem]">
                ...
                or &quot;Our&quot; in this Agreement) refers to Lumber LLC, 140 Jackson St 3D Brooklyn, NY 11211 United
                States.
              </p>
            </li>
            <li>
            ...
            <li>
              <p className="mb-5 text-[1.5rem]">
                ...
                <a href="https://www.privacypolicies.com/terms-conditions-generator/" target="_blank" rel="noreferrer">
            ...
            <li>
              <p className="mb-5 text-[1.5rem]">
                <strong>Website</strong> refers to Sum It Up, accessible from{" "}
                <a href="https://sumitup.app/" rel="external nofollow noopener noreferrer" target="_blank">
                  https://sumitup.app/
                </a>
              </p>
            </li>
          ...
          <h1 className="my-[3rem] text-center text-[3rem] font-bold leading-[4rem]">Acknowledgment</h1>
          <p className="mb-5 text-[1.5rem]">
          ...
          <h1 className="my-[3rem] text-center text-[3rem] font-bold leading-[4rem]">Links to Other Websites</h1>
          <p className="mb-5 text-[1.5rem]">
          ...
          <h1 className="my-[3rem] text-center text-[3rem] font-bold leading-[4rem]">Termination</h1>
          <p className="mb-5 text-[1.5rem]">
            We may terminate or suspend Your access immediately, without prior notice or liability, for any reason
            whatsoever, including without limitation if You breach these Terms and Conditions.
          </p>
          <p className="mb-5 text-[1.5rem]">Upon termination, Your right to use the Service will cease immediately.</p>
          <h1 className="my-[3rem] text-center text-[3rem] font-bold leading-[4rem]">Limitation of Liability</h1>
          <p className="mb-5 text-[1.5rem]">
          ...
          <h1 className="my-[3rem] text-center text-[3rem] font-bold leading-[4rem]">
          ...
          <h1 className="my-[3rem] text-center text-[3rem] font-bold leading-[4rem]">Governing Law</h1>
          <p className="mb-5 text-[1.5rem]">
          ...
          <h1 className="my-[3rem] text-center text-[3rem] font-bold leading-[4rem]">Disputes Resolution</h1>
          <p className="mb-5 text-[1.5rem]">
          ...
          <h1 className="my-[3rem] text-center text-[3rem] font-bold leading-[4rem]">For European Union (EU) Users</h1>
          <p className="mb-5 text-[1.5rem]">
          ...
          <h1 className="my-[3rem] text-center text-[3rem] font-bold leading-[4rem]">United States Legal Compliance</h1>
          <p className="mb-5 text-[1.5rem]">
          ...
          <h1 className="my-[3rem] text-center text-[3rem] font-bold leading-[4rem]">Severability and Waiver</h1>
          <h2 className="my-[2rem] text-[2rem] font-bold">Severability</h2>
          <p className="mb-5 text-[1.5rem]">
          ...
          <h2 className="my-[2rem] text-[2rem] font-bold">Waiver</h2>
          <p className="mb-5 text-[1.5rem]">
          ...
          <h1 className="my-[3rem] text-center text-[3rem] font-bold leading-[4rem]">Translation Interpretation</h1>
          <p className="mb-5 text-[1.5rem]">
          ...
          <h1 className="my-[3rem] text-center text-[3rem] font-bold leading-[4rem]">Contact Us</h1>
          <p className="mb-5 text-[1.5rem]">
