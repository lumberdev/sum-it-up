    ...
    <>
      ...
      <Container className="mt-10 p-10 text-justify text-paragraph text-dark">
        <div className="mb-[4rem] text-[1.5rem]">
          ...
          <p className="mt-5 mb-[3rem] text-center text-[1.2rem] italic">Last updated: February 21, 2023</p>
          ...
          <ul className="ml-[4rem]">
            ...
            <li className="mb-5 list-disc">
              <p className="mb-5 text-[1.5rem]">
                ...
                or &quot;Our&quot; in this Agreement) refers to Lumber, Brooklyn, NY.
              </p>
            </li>
            <li className="mb-5 list-disc">
              <p className="mb-5 text-[1.5rem]">
          ...
          <ul className="ml-[4rem]">
            <li className="mb-5 list-disc">Usage Data</li>
          </ul>
          <h3 className="mb-5 text-[1.5rem] font-bold">Usage Data</h3>
          <p className="mb-5 text-[1.5rem]">Usage Data is collected automatically when using the Service.</p>
          <p className="mb-5 text-[1.5rem]">
          ...
          <h3 className="mb-5 text-[1.5rem] font-bold">Tracking Technologies and Cookies</h3>
          <p className="mb-5 text-[1.5rem]">
          ...
          <ul className="ml-[4rem]">
            <li className="mb-5 list-disc">
              ...
              <p className="mb-5 text-[1.5rem]">Type: Session Cookies</p>
              <p className="mb-5 text-[1.5rem]">Administered by: Us</p>
              <p className="mb-5 text-[1.5rem]">
            ...
            <li className="mb-5 list-disc">
              ...
              <p className="mb-5 text-[1.5rem]">Type: Persistent Cookies</p>
              <p className="mb-5 text-[1.5rem]">Administered by: Us</p>
              <p className="mb-5 text-[1.5rem]">
          ...
          <p className="mb-5 text-[1.5rem]">We may share Your personal information in the following situations:</p>
          <ul className="ml-[4rem]">
            <li className="mb-5 list-disc">
          ...
          <ul className="ml-[4rem]">
            <li className="mb-5 list-disc">Comply with a legal obligation</li>
            <li className="mb-5 list-disc">Protect and defend the rights or property of the Company</li>
            <li className="mb-5 list-disc">
          ...
          <h1 className="my-[3rem] text-center text-[2.5rem] font-bold">Children&apos;s Privacy</h1>
          <p className="mb-5 text-[1.5rem]">
          ...
          <h1 className="my-[3rem] text-center text-[2.5rem] font-bold">Links to Other Websites</h1>
          <p className="mb-5 text-[1.5rem]">
          ...
          <h1 className="my-[3rem] text-center text-[2.5rem] font-bold">Changes to this Privacy Policy</h1>
          <p className="mb-5 text-[1.5rem]">
          ...
          <h1 className="my-[3rem] text-center text-[2.5rem] font-bold">Contact Us</h1>
          <p className="mb-5 text-[1.5rem]">If you have any questions about this Privacy Policy, You can contact us:</p>
          <ul className="ml-[4rem]">
            <li className="mb-5 list-disc">
              By email:{" "}
