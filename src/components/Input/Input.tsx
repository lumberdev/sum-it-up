  ...
  return (
    <Container>
      <div className="mx-auto w-full py-20 text-center">
        <div className="relative mx-auto mb-12 inline-flex h-[4.5rem] w-full max-w-[28rem] items-center justify-center rounded-full bg-primary p-2 text-white md:mb-[7rem] md:max-w-[33rem]">
        ...
        {inputTypeSelected === InputType.ARTICLE && (
          <WebsiteInputField
