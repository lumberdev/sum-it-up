...
const TextResult = ({ textSummaryResponse, handNewSearchBtnClick }: ResultProp) => {
        ...
        {resultType === "analysis" && textSummaryResponse && (
          <>
            ...
            <div className="rounded-md bg-medium p-8">
              <h4 className="my-2 text-heading4 font-bold">Bias: {textSummaryResponse.bias}</h4>
              <div className="mb-4 p-2">This articles has a {textSummaryResponse.bias} bias</div>
              <h4 className="my-2 text-heading4 font-bold">Tone: {textSummaryResponse.tone}</h4>
              <div className="p-2">This articles has a {textSummaryResponse.tone} tone</div>
            </div>
          </>
        )}
      </div>
