export const mockData = {
  keyPoints: [
    ...
    'Drive Pilot will only operate at speeds up to 40 mph on “suitable freeway sections and where there is high traffic density”',
    ...
    'Level 3 systems are not without their risks',
